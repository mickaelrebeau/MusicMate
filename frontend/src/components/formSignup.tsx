        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="w-[400px] flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                    <label className="font-semibold mb-1" htmlFor="pseudo">Pseudo</label>
                    {errors.pseudo && <span className="text-red-500 text-right">{errors.pseudo.message}</span>}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {errors.email && <span className="text-red-500 text-right">{errors.email.message}</span>}
                ...
                <div className="flex flex-col gap-2">
                    ...
                    {errors.password && <span className="text-red-500 text-right">{errors.password.message}</span>}
                    <input {...register("password")} className="rounded p-2" id="password" type="password" name="password" defaultValue={user.password} placeholder="Password" onChange={handleChange} />
                </div> 
            </div>
        </div>
    )
