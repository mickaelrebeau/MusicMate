    ...
    return (
        <>
            <section className="h-full flex flex-col items-center justify-center text-center animate-fadeIn">
                ...
                <p className="mt-8 px-10 py-3 rounded-xl text-2xl font-semibold text-indigo-500 border-indigo-500 hover:text-white hover:bg-gradient-to-r from-indigo-600 to-purple-400 hover:shadow-2xl hover:shadow-indigo-500/50">
                    <NavLink to={"/signup"} >Get Started</NavLink>
                </p>
                <p className="mt-8 text-slate-500">
                    Already have an account ?
                    <NavLink className="text-indigo-500 ml-2 hover:text-purple-400" to={"/login"} >Log in</NavLink>
                </p>
            </section>
        </>
    )
