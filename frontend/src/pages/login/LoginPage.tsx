    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col gap-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="w-[400px] flex flex-col gap-8">
                    ...
                    <button className="px-10 py-1 mt-4 rounded text-2xl font-semibold hover:bg-gradient-to-r from-indigo-600 to-purple-400 hover:shadow-2xl hover:shadow-indigo-500/50" type="submit">Submit</button>
                </form>
            </div>
        </div>
    )
